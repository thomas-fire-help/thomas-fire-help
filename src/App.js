...
import LFIndividualVolunteerForm from './screens/looking_for_resources/IndividualVolunteerForm'
  ...
  <BrowserRouter>
    <ModuleProvider store={store} combineReducers={combineReducers}>
      <AppContainer>
        ...
        <Route exact path="/looking_for_resources/volunteers/individual" component={LFIndividualVolunteerForm} />
